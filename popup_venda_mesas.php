<?php 
    //$caixa = "delivery";
    include 'din_vendaDAO_mesas.php'; 
?>
  ...
  echo '<div id="venda" class="overlay">
  	<div class="popup_venda">
            ...
            <div class="content"><br>
                <a href="#popup_din_del" class="ui fluid basic button"><i class="money icon"></i>Dinheiro</a><br>';
                while ($forma = mysql_fetch_array($buscaFormas))
                    {
                        echo '<a href="vendaDAO_mesas.php?mesa='.$id_mesa.'&din='.$subtotal.'&forma='.$forma['id'].'" class="ui fluid basic button"><i class="'.$forma['icone'].'"></i>'.$forma['forma_pagamento'].'</a>';
                        echo '<br>';
                    } 
            echo '</div>'
       .'</div>'
