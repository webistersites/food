...
<div id="pizzas" class="overlay">
  <div class="popup_pizzas">
    <h4 class="ui center aligned header">Escolher 3 sabores</h4>
    <a class="close" href="#">&times;</a>
      <div class="content">

        <form id='students' method='post' name='students' action='recebe_3sabores.php'>
        ...
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <?php echo '<input type="hidden" id="mesa" name="mesa" value="'.$mesa.'">'; ?>
        ...
        <button type="submit" class='btn btn-primary'>Selecionar</button>
          ...
          <?php echo '<a href="../mesa'.$mesa.'.php" class="btn btn-primary">Cancelar</a>'; ?>
      </div>
    </div>
  </div>
