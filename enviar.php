...
if ($nome > $email) 
{
	...
	$result .= '<a class="ui green right floated button" href="vendaDAO_delivery.php?forma=1&din='.$nome.'&troco='.$aux.'">Encerrar Venda</a><br><br>';
}
elseif ($nome < $email) 
{
	$aux = $email - $nome;
	...
	$result .= '<a class="ui basic green button" href="vendaDAO_delivery.php?forma=5&din='.$nome.'&resto='.$aux.'">Finalizar Crédito</a>';
	$result .= '<a class="ui basic green right floated button" href="vendaDAO_delivery.php?forma=4&din='.$nome.'&resto='.$aux.'">Finalizar Débito</a><br><br>';
}
else
{
	$aux = 0;
	...
	$result .= '<div class="ui center aligned container">
				<div class="ui huge positive compact message">
				  ...
				  $result .= "<a href='vendaDAO_delivery.php?forma=1&din=".$nome."&troco=0' class='ui green right floated button'>Encerrar Venda</a><br><br>";
}
