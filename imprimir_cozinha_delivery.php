...
/*        $txt_valor_total = "-------------------------------------------------------\r\n";
	 ...
	 */
        ...
        $file = 'cupom_cozinha_delivery.txt';
...
{
   $fh = fopen("cupom_cozinha_delivery.txt", "rb");
   $content = fread($fh, filesize("cupom_cozinha_delivery.txt"));
   fclose($fh);
