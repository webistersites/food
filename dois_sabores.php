    ...
    <body>
        <div id="content" class="ui form">
            <form autocomplete="off" onsubmit="return false;">
                ...
                <input value="Selecionar" id="meuBotao" onclick="insereSabores2()" type="button" />
                <br>
                <a href="javascript:void(0);" class="ui teal right floated button" onclick="insereSabores2()">Selecionar</a>
                <br><br>
            </form>
        </div>
